...
OutputBaseFilename=cubepdf-x64
...
Source: ..\release\x64\cubepdf.exe; DestDir: {app}; Flags: ignoreversion 64bit
Source: ..\release\x64\cubepdf-redirect.exe; DestDir: {app}; Flags: ignoreversion 64bit
Source: ..\release\x64\cubepdf-checker.exe; DestDir: {app}; Flags: ignoreversion 64bit
Source: ..\release\x64\cube-key-gen.exe; Flags: dontcopy 64bit
Source: ..\release\x64\cliff.dll; DestDir: {app}; Flags: ignoreversion 64bit
Source: ..\release\x64\gsdll32.dll; DestDir: {app}; Flags: ignoreversion 64bit
...
Source: ..\release\x64\ghostscript\*; DestDir: {win}\CubePDF; Flags: ignoreversion recursesubdirs createallsubdirs 64bit
Source: ..\release\x64\redmon\redmonnt.dll; DestDir: {sys}; DestName: cuberedmon.dll; Flags: ignoreversion onlyifdoesntexist 64bit
Source: ..\release\x64\printer\CubePDF.PPD; DestDir: {code:GetPrinterDriverDirectoryName|}
Source: ..\release\x64\printer\PS5UI.DLL; DestDir: {code:GetPrinterDriverDirectoryName|}; Flags: ignoreversion onlyifdoesntexist deleteafterinstall 64bit
Source: ..\release\x64\printer\PSCRIPT5.DLL; DestDir: {code:GetPrinterDriverDirectoryName|}; Flags: ignoreversion onlyifdoesntexist deleteafterinstall 64bit
Source: ..\release\x64\printer\PSCRIPT.NTF; DestDir: {code:GetPrinterDriverDirectoryName|}; Flags: ignoreversion onlyifdoesntexist deleteafterinstall
Source: ..\release\x64\printer\PSCRIPT.HLP; DestDir: {code:GetPrinterDriverDirectoryName|}; Flags: ignoreversion onlyifdoesntexist deleteafterinstall 64bit
